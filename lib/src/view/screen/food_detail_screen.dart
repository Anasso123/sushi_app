...
import 'package:sushi_shop/src/view/widget/counter_button.dart';
import 'package:sushi_shop/src/view/widget/scale_animation.dart';
...
class FoodDetailScreen extends StatelessWidget {
  ...
  Widget fab(VoidCallback onPressed) {
    return FloatingActionButton(
      ...
      onPressed: onPressed,
      child: const Icon(AppIcon.heart),
    );
  }
